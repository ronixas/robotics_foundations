...
get_filename_component(_filename "/home/rflab/ros_ws/src/lab5_pkg/srv/capture.srv" NAME_WE)
add_custom_target(_lab5_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lab5_pkg" "/home/rflab/ros_ws/src/lab5_pkg/srv/capture.srv" ""
)
...
_generate_srv_cpp(lab5_pkg
  "/home/rflab/ros_ws/src/lab5_pkg/srv/capture.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab5_pkg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab5_pkg\")")
  # install generated code
  install(
